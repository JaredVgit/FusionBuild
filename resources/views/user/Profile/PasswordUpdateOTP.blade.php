...
<div class="p-8 max-w-2xl mx-auto">
    <div class="bg-darkBlue text-white p-6 rounded-lg shadow-lg">
        ...
        <div class="flex justify-end mb-6">
            <a href="{{ route('Profile') }}" class="bg-mustardOrange text-black font-bold py-2 px-4 rounded-lg hover:bg-yellow-500 transition">
                ← Profile
            </a>
        </div>
        ...
        <form action="{{ route('PasswordUpdateOTPverify') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="text-center mt-4">
                <p class="text-gray-300 text-sm">Didn't receive an OTP? 
                    <a href="{{ route('PasswordUpdateOTPresend') }}" class="text-mustardOrange font-bold hover:underline">Resend</a>
                </p>
            </div>
        </form>
    </div>
